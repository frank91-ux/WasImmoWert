  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="mb-12 bg-teal-50 border border-teal-200 rounded-lg p-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Fakten über WasImmoWert</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <p className="text-sm font-medium text-teal-700 mb-1">Gründung</p>
              <p className="text-lg text-gray-900 font-semibold">2022</p>
            </div>
            <div>
              <p className="text-sm font-medium text-teal-700 mb-1">Sitz</p>
              <p className="text-lg text-gray-900 font-semibold">Berlin, Deutschland</p>
            </div>
            <div>
              <p className="text-sm font-medium text-teal-700 mb-1">Fokus</p>
              <p className="text-lg text-gray-900 font-semibold">Immobilienbewertung</p>
            </div>
            <div>
              <p className="text-sm font-medium text-teal-700 mb-1">Nutzer</p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-teal-600 font-medium">press@wasimmowert.de</p>
